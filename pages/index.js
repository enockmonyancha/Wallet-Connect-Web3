...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      {/* Header Text */}
      <h1 className="text-3xl mt-5 sm:text-5xl font-bold text-center text-yellow-300">
        ENDING THE YEAR WITH A BONK
      </h1>
      <h2 className="text-2xl sm:text-4xl mt-5 text-yellow-300">YEAR OF REWARDS</h2>

      <WalletBalance />

      {/* Dragon Section */}
      <div className='mt-10'>
          <img src="temple4.png" alt="Dragon" width="290" />
        </div>
